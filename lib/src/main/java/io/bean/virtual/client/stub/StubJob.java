...
import static io.bean.virtual.server.job.VJobSchedulerService.JobConfig;
import static io.bean.virtual.server.job.VJobSchedulerService.JobId;
import static io.bean.virtual.server.job.VJobSchedulerService.get;
