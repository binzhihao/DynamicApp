...
public class BroadcastSystem {
     ...
     * at io.bean.virtual.server.am.BroadcastSystem.startApp(BroadcastSystem.java:54)
     * at io.bean.virtual.server.pm.VAppManagerService.install(VAppManagerService.java:193)
     * at io.bean.virtual.server.pm.VAppManagerService.preloadAllApps(VAppManagerService.java:98)
     * at io.bean.virtual.server.pm.VAppManagerService.systemReady(VAppManagerService.java:70)
     * at io.bean.virtual.server.BinderProvider.onCreate(BinderProvider.java:42)
     */
