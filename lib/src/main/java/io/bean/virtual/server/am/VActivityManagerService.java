package io.bean.virtual.server.am;
...
import io.bean.virtual.client.IVClient;
import io.bean.virtual.client.core.VirtualCore;
import io.bean.virtual.client.env.SpecialComponentList;
import io.bean.virtual.client.ipc.ProviderCall;
...
import io.bean.virtual.helper.compat.IApplicationThreadCompat;
import io.bean.virtual.helper.utils.ComponentUtils;
import io.bean.virtual.helper.utils.VLog;
import io.bean.virtual.helper.collection.ArrayMap;
import io.bean.virtual.helper.collection.SparseArray;
import io.bean.virtual.os.VBinder;
import io.bean.virtual.os.VUserHandle;
import io.bean.virtual.remote.AppTaskInfo;
import io.bean.virtual.remote.PendingIntentData;
import io.bean.virtual.remote.PendingResultData;
import io.bean.virtual.remote.VParceledListSlice;
import io.bean.virtual.server.IActivityManager;
import io.bean.virtual.server.interfaces.IProcessObserver;
import io.bean.virtual.server.pm.PackageCache;
import io.bean.virtual.server.pm.PackageSetting;
import io.bean.virtual.server.pm.VAppManagerService;
import io.bean.virtual.server.pm.VPackageManagerService;
import io.bean.virtual.server.secondary.BinderDelegateService;
...
import static io.bean.virtual.os.VUserHandle.getUserId;
...
public class VActivityManagerService extends IActivityManager.Stub {
    ...
    private int parseVPid(String stubProcessName) {
        String prefix = VirtualCore.get().getHostPkg() + PREFIX;
