...
import io.bean.virtual.helper.collection.IntArray;
import io.bean.virtual.helper.compat.NativeLibraryHelperCompat;
import io.bean.virtual.helper.compat.PackageParserCompat;
import io.bean.virtual.helper.utils.FileUtils;
...
import io.bean.virtual.server.am.UidSystem;
...
public class VAppManagerService extends IAppManager.Stub {
    ...
    public synchronized InstallResult installPackage(String path, int flags) {
        ...
        if (existOne != null) {
            ...
            if (noNeedToUpdate(existOne, pkg)) {
                res.isSuccess = true;
                return res;
            }
    ...
    private boolean noNeedToUpdate(PackageParser.Package existOne, PackageParser.Package newOne) {
